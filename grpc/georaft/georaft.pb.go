...
type L2SAppendEntriesArgs struct {
	Term                 int32    `protobuf:"varint,1,opt,name=Term,proto3" json:"Term,omitempty"`
	LeaderId             int32    `protobuf:"varint,2,opt,name=LeaderId,proto3" json:"LeaderId,omitempty"`
	PrevLogIndex         int32    `protobuf:"varint,3,opt,name=PrevLogIndex,proto3" json:"PrevLogIndex,omitempty"`
	PrevLogTerm          int32    `protobuf:"varint,4,opt,name=PrevLogTerm,proto3" json:"PrevLogTerm,omitempty"`
...
func (m *L2SAppendEntriesArgs) Reset()         { *m = L2SAppendEntriesArgs{} }
func (m *L2SAppendEntriesArgs) String() string { return proto.CompactTextString(m) }
func (*L2SAppendEntriesArgs) ProtoMessage()    {}
func (*L2SAppendEntriesArgs) Descriptor() ([]byte, []int) {
	return fileDescriptor_9d670479826b17d8, []int{5}
}

func (m *L2SAppendEntriesArgs) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_L2SAppendEntriesArgs.Unmarshal(m, b)
}
func (m *L2SAppendEntriesArgs) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_L2SAppendEntriesArgs.Marshal(b, m, deterministic)
}
func (m *L2SAppendEntriesArgs) XXX_Merge(src proto.Message) {
	xxx_messageInfo_L2SAppendEntriesArgs.Merge(m, src)
}
func (m *L2SAppendEntriesArgs) XXX_Size() int {
	return xxx_messageInfo_L2SAppendEntriesArgs.Size(m)
}
func (m *L2SAppendEntriesArgs) XXX_DiscardUnknown() {
	xxx_messageInfo_L2SAppendEntriesArgs.DiscardUnknown(m)
}

var xxx_messageInfo_L2SAppendEntriesArgs proto.InternalMessageInfo

func (m *L2SAppendEntriesArgs) GetTerm() int32 {
	if m != nil {
		return m.Term
	}
	return 0
...
func (m *L2SAppendEntriesArgs) GetLeaderId() int32 {
	if m != nil {
		return m.LeaderId
	}
	return 0
...
func (m *L2SAppendEntriesArgs) GetPrevLogIndex() int32 {
	if m != nil {
		return m.PrevLogIndex
	}
	return 0
...
func (m *L2SAppendEntriesArgs) GetPrevLogTerm() int32 {
	if m != nil {
		return m.PrevLogTerm
	}
	return 0
...
func (m *L2SAppendEntriesArgs) GetLog() []byte {
	if m != nil {
		return m.Log
	}
	return nil
...
func (m *L2SAppendEntriesArgs) GetLeaderCommit() int32 {
	if m != nil {
		return m.LeaderCommit
	}
	return 0
...
func (*L2SAppendEntriesReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_9d670479826b17d8, []int{6}
}
...
func init() {
	...
	proto.RegisterType((*L2SAppendEntriesArgs)(nil), "L2SAppendEntriesArgs")
...
var fileDescriptor_9d670479826b17d8 = []byte{
	...
	,
}
...
type SecretaryClient interface {
	// Sends a greeting
	L2SAppendEntries(ctx context.Context, in *L2SAppendEntriesArgs, opts ...grpc.CallOption) (*L2SAppendEntriesReply, error)
}
...
func (c *secretaryClient) L2SAppendEntries(ctx context.Context, in *L2SAppendEntriesArgs, opts ...grpc.CallOption) (*L2SAppendEntriesReply, error) {
...
type SecretaryServer interface {
	// Sends a greeting
	L2SAppendEntries(context.Context, *L2SAppendEntriesArgs) (*L2SAppendEntriesReply, error)
}
...
func (*UnimplementedSecretaryServer) L2SAppendEntries(ctx context.Context, req *L2SAppendEntriesArgs) (*L2SAppendEntriesReply, error) {
...
func _Secretary_L2SAppendEntries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SecretaryServer).L2SAppendEntries(ctx, req.(*L2SAppendEntriesArgs))
	}
	return interceptor(ctx, in, info, handler)
}
